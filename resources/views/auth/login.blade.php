...
<div class="SM-sw-form-body" style="min-height: 95vh;">
    <div class="container flexR ">
        <div class='minHeaderBg w70p bwhite boxS1px' style="height:unset; border-radius: 10px 0px 0px 10px"> 
            <h2 class="tend pwrap-10"><u><b class='fpacifico'>Derivative Notes</b> <i class='fBebasNeue'>"DN / CT"</i></u></h2> 
        </div>
        <div class="SM-sw-form" style="height: 600px; border-radius: 0px 10px 10px 0px">  	
